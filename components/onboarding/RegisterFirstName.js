...
function RegisterFirstName({ navigation }) {
    ...
    return (
        <View style={styles.mainView}>
            <RegisterProgressBar navigation={navigation} progress="0%" />
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.container}>
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.inner}>
                        <TouchableOpacity disabled={disabled ? true : false} style={[styles.btnContainer, { backgroundColor: disabled ? "#D2D3D3" : "#FF3D60" }]} onPress={() => {navigation.navigate("RegisterLastName")}}>
